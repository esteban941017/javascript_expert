 ...
 * Para acessar as classes sem o new, pode acessar direto via protype
 */
...
// Quando chamamos com o 'new', o __prototype__ recebe o prototype
console.log('manager.__proto__', new Manager().__proto__, new Manager().salary());
